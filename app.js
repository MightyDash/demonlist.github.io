...
const THUMBNAIL_EXTENSIONS = ["webp", "png", "jpg", "jpeg", "WEBP", "PNG", "JPG", "JPEG"];
const FACE_BASE_PATH = "./assets/faces";
const FACE_EXTENSIONS = ["png", "webp", "jpg", "jpeg", "PNG", "WEBP", "JPG", "JPEG"];
...
function buildThumbnailCandidates(item) {
  ...
  if (item.name) {
    ...
    bases.push(trimmedName.toUpperCase());
    bases.push(slugifyFileName(trimmedName));
    bases.push(slugifyFileName(trimmedName).toUpperCase());
  }
